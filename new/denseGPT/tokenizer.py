...
wrapped_tokenizer.save_pretrained("new/denseGPT/saved/tokenizer")

tok = AutoTokenizer.from_pretrained("new/denseGPT/saved/tokenizer")

tokens = tok.tokenize("Test number 2.!@#$%^&*() Yo ho ho ski bidi biden <think></think><eos>")
